...
<div className="container">
  ...
  <div class="card-body">
    ...
    <div className="col-sm">
    <div class="card" >
  <img src="homeloan.jpeg" class="card-img-top" alt="..." height="200px"/>
  <div class="card-body">
    <h5 class="card-title">Home loan</h5>
    <p class="card-text">An home loan is a sum of money borrowed to purchase house. Home loans are intended to cover the cost of rent,bills and supplies, and living expenses.it comprises of all necessary details .</p>
    <Link to="Applicationform" onClick={Application} class="btn btn-primary">Click</Link>
  </div>
</div>
    </div>
    <div className="col-sm">
    <div class="card" >
  <img src="personalloan.jpeg" class="card-img-top" alt="..." height="200px"/>
  <div class="card-body">
    <h5 class="card-title">Personal loan</h5>
    <p class="card-text">An personal loan is a sum of money borrowed to finance  for personal expenses.this mainly for the personal use and living expences.it comprises of all necessary details.</p>
    <Link to="Applicationform" onClick={Application} class="btn btn-primary">Click</Link>
  </div>
