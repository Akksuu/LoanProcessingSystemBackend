        ...
        <h1 >Please fill this transcation form !!!</h1>
            <Grid>
                <Paper elevation={20} style={paperStyle}>
                    ...
                    <form>
                        <TextField fullWidth label='Name' pattern="[A-Z]{1}[a-z]{7}" placeholder="Enter your name"   />
                        <TextField fullWidth label='Email' pattern="[A-Z]{1}[a-z]{5}[@]{1}[a-z]{5}[.]{1}[a-z]{3}" placeholder="Enter your email"   />
                        ...
                        <TextField fullWidth label='Confirm Password' type="number" placeholder="Confirm your password"  />
                        <TextField fullWidth label='Address' type="text" placeholder="Enter your Address"  />
                        <FormControlLabel
