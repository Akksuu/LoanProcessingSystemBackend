 ...
 * "/add user as admin" is to add admin to the user table
 * "/add user as loan manager" to add finance officer to the user table
 * "/sign in" to sign in into the account
